    ...
    <div class="top-sec">
        <div class="top-search">
            <form action="" method="GET">
                <input type="text" name="search" placeholder="Find Document" value="<?= (isset($_GET['s'])) ? $_GET['s'] : '' ?>">
            ...
            <ul class="fold-view">
                ...
                <li class="fold-l">
                    <div class="l-dots">
                        ...
                        <div class="slide-div">
                            <ul>
                                <li><a href="{{SYSTEM_SITE_URL}}user/folderdownload/{{$parentfolder->id}}">Download</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    $file_count = $file_model::getfilecountbyfolder($parentfolder->id); //echo "<pre>"; print_r($share_members); die(); 
                    ?>
                ...
                <li>
                    <div class="l-dots">
                        ...
                        <div class="slide-div">
                            <ul>
                                <li><a href="{{SYSTEM_SITE_URL}}user/download/{{$parentfile->id}}">Download</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="members">
                        <?php $share_model = app("App\\admin\\Share");
                        $share_members = $share_model::getsharedmemberesbyfile($parentfile->id);
                        if (count($share_members) > 0) {
                            echo count($share_members) . ' Members';
                        } else {
                            echo "Only You";
                        } //echo "<pre>"; print_r($share_members); die(); 
                        ?>
                    </div>
