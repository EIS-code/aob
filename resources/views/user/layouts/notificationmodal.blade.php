  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="text-center all"><a href="{{SYSTEM_SITE_URL}}notifications">View All</a></div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="note-list">
          ...
          <li><a href="{{SYSTEM_SITE_URL}}logout">Logout</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="profile-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{SYSTEM_SITE_URL}}updateprofile" method="POST" enctype="multipart/form-data" >
          @csrf
...
<div class="modal fade" id="changepassword-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{SYSTEM_SITE_URL}}updatepassword" method="POST" >
          @csrf
          <div class="profile-middle">
            <div class="pro-grp">
