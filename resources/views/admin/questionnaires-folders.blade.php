...
<div class="dashboard-main folder-grd">
  ...
  <section class="right-side">
  	<div class="right-tp-top d-flex">
        <div class="tp-left">
            <h2><a href="{{ADMIN_SYSTEM_SITE_URL}}questionnaire">Questionnaire</a>
            <ul>
                <li>
            ...
            <small>Created: <span>{{date('d F Y',strtotime($folder->created_at))}}</span> </small>
        </div>
        <div class="tp-right">
        	<div class="dp-top">
            	<ul class="prof">
    ...
    <div class="right-content-sec">
        ...
        <div class="right-mid-section que-detail">
              	...
              	<ul class="fold-view">
                    ...
                    <li>
                        <div class="l-dots">
                            ...
                            <div class="slide-div">
                                <ul>
                                    <li><a href="{{ADMIN_SYSTEM_SITE_URL}}questionnaire/file/download/{{$file->id}}">Download</a></li>
                                    <li><a href="#"  onclick="deleteak('{{ADMIN_SYSTEM_SITE_URL}}questionnaire/file/delete/{{$file->id}}');" >Delete</a></li>
                                </ul>
                            </div>
                        </div>
