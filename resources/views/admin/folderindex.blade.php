...
<div class="dashboard-main folder-grd">
  ...
  <section class="right-side">
    <div class="right-tp-top d-flex">
        <div class="tp-left">
            <h2><a href="{{ADMIN_SYSTEM_SITE_URL}}folder">AOB</a>
            <ul>
                <li>
                @foreach($data['breadcrumps'] as $key => $breadcrump)
                    <a href="{{ADMIN_SYSTEM_SITE_URL}}folder/{{$breadcrump->id}}"> {{$breadcrump->name}} </a>
        ...
        <div class="tp-right">
            <div class="dp-top">
                <ul class="prof">
                <?php $share_model = app("App\\admin\\Share"); $share_members = $share_model::getsharedmemberes($data['folder']->id);  ?>
                    <?php $j=1; ?>
                        ...
                        <div class="l-dots">
                            ...
                            <div class="slide-div">
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0);" onclick="deleteak('{{ADMIN_SYSTEM_SITE_URL}}folder/deletefolder/{{$parentfolder->id}}');">Delete</a></li>
                        ...
                        <div class="l-dots">
                            ...
                            <div class="slide-div">
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0);" onclick="deleteak('{{ADMIN_SYSTEM_SITE_URL}}folder/deletefile/{{$parentfile->id}}');">Delete</a></li>
